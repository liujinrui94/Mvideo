...
public class TabRGFragmentAdapter implements RadioGroup.OnCheckedChangeListener {
    ...
    public TabRGFragmentAdapter(FragmentActivity fragmentActivity, List<Fragment> fragments, int fragmentContentId,
