...
//        Interval = (int) context.getResources().getDimension(R.dimen.x10);
        Interval = (int) context.getResources().getDimension(R.dimen.dp_10);
//        mWidthClear = (int) context.getResources().getDimension(R.dimen.x30);
        mWidthClear = (int) context.getResources().getDimension(R.dimen.dp_30);
