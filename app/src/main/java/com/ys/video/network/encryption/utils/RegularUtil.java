...
public class RegularUtil {
    ...
    public static boolean isPhone(String phone) {
         ...
         * 4G号段 177
         * new 133、149、153、173、177、180、181、189、199
         *
         * 联通
         * 中国联通手机号码开头数字
         ...
         * 4G号段 176、185[1]
         * new 130、131、132、145、155、156、166、171、175、176、185、186
         * 移动
         * 中国移动手机号码开头数字
         ...
         * 3G上网卡 147
         * 4G号段 178
         * new 134(0-8)、135、136、137、138、139、147、150、151、152、157、158、159、178、182、183、184、187、188、198
         *
         * 补充
         *
        ...
        Pattern regex   = Pattern.compile("^((1[358][0-9])|(14[5-9])|(1[69][5-9])|(17[0-9]))\\d{8}$");
//        Pattern regex   = Pattern.compile("^(1[2-9])\\d{9}$"); // 首位 1开头 第二位 2-9 后续9位
